...
/***************************************************************************
 *
 *	MyBB jQuery Color Picker plugin (/inc/languages/french/admin/customcolor.lang.php)
...
$l["customcolor_enable_input_title"] = "Activer le selecteur de couleur du panneau inferieur a la place";

$l["customcolor_enable_input_desc"] = "N activez cette option que si vous preferez que le selecteur de couleur soit entre dans le panneau inferieur du membre du bloc de bienvenue.<br /><br /> Remarque: en activant cette option, vous aurez le selecteur de couleur dans le panneau inferieur du bloc de bienvenue du membre comme vous le souhaitez, mais vous conserverez toujours la fonction de retour de couleur dans les options d edition usercp. ";
