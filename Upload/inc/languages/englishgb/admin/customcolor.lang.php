...
$l["customcolor_enable_input_title"] = "Enable Lower Panel Color Selector Instead";

$l["customcolor_enable_input_desc"] = "Only enable this if you would rather have the color selector input in the welcomeblock member lower panel.<br /><br /> Note: by enabling this you will have the color selector in the member welcomeblock lower panel as desired but will still retain the revert color function in usercp edit options.";
