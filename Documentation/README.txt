...
- added option to enable / disable either having the color selector input via usercp edit options where the revert color option is or disable that selector only and enable the selector in member welcomeblock lower panel instead
